...
public class GuiPlacer extends GuiContainer{
    ...
    private static String texture = ModInformation.MODID + ":textures/gui/placer.png";

    public GuiPlacer(IInventory playerInv, TileEntityPlacer te, EntityPlayer player) {
        super(new ContainerPlacer(playerInv, te, player));

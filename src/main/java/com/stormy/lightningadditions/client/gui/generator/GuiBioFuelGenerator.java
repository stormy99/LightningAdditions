...
public class GuiBioFuelGenerator extends GuiContainer{

    private TileEntityBioFuelGenerator te;
    private IInventory playerInv;

    public GuiBioFuelGenerator(IInventory playerInv, TileEntityBioFuelGenerator te) {
        super(new ContainerBioFuelGenerator(playerInv, te));

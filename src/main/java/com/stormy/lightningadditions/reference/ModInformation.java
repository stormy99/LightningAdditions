...
{
    public static final String MODID = "lightningadditions";
    public static final String MODNAME = "Lightning Additions";
    ...
    public static final String DEPS = "required-after:ninetaillib, required-after:codechickenlib";

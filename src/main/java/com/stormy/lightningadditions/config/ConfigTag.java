...
@Deprecated
public class ConfigTag extends com.stormy.lightningadditions.config.ConfigTagParent {

    public com.stormy.lightningadditions.config.ConfigTagParent parent;
    public String name;
    ...
    public ConfigTag(com.stormy.lightningadditions.config.ConfigTagParent parent, String name) {
        this.parent = parent;
        this.name = name;

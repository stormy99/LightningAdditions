...
public class WorldGen implements IWorldGenerator{
    ...
    {
        try {
            if (LAModConstants.copperOre && !JsonParserModdedOres.loadNetherCopperOre().get("disableOre").getAsBoolean())
                generateOre(ModBlocks.NETHER_COPPER_ORE, world, random, x, z, 1, blockSize(JsonParserModdedOres.loadNetherCopperOre().get("veinMinimum").getAsInt(), JsonParserModdedOres.loadNetherCopperOre().get("veinMultiplier").getAsInt()), JsonParserModdedOres.loadNetherCopperOre().get("rarity").getAsInt(), JsonParserModdedOres.loadNetherCopperOre().get("minY").getAsInt(), JsonParserModdedOres.loadNetherCopperOre().get("maxY").getAsInt(), Blocks.NETHERRACK);
            if (LAModConstants.leadOre && !JsonParserModdedOres.loadNetherLeadOre().get("disableOre").getAsBoolean())
                generateOre(ModBlocks.NETHER_LEAD_ORE, world, random, x, z, 1, blockSize(JsonParserModdedOres.loadNetherLeadOre().get("veinMinimum").getAsInt(), JsonParserModdedOres.loadNetherLeadOre().get("veinMultiplier").getAsInt()), JsonParserModdedOres.loadNetherLeadOre().get("rarity").getAsInt(), JsonParserModdedOres.loadNetherLeadOre().get("minY").getAsInt(), JsonParserModdedOres.loadNetherLeadOre().get("maxY").getAsInt(), Blocks.NETHERRACK);
            if (LAModConstants.tinOre && !JsonParserModdedOres.loadNetherTinOre().get("disableOre").getAsBoolean())
                generateOre(ModBlocks.NETHER_TIN_ORE, world, random, x, z, 1, blockSize(JsonParserModdedOres.loadNetherTinOre().get("veinMinimum").getAsInt(), JsonParserModdedOres.loadNetherTinOre().get("veinMultiplier").getAsInt()), JsonParserModdedOres.loadNetherTinOre().get("rarity").getAsInt(), JsonParserModdedOres.loadNetherTinOre().get("minY").getAsInt(), JsonParserModdedOres.loadNetherTinOre().get("maxY").getAsInt(), Blocks.NETHERRACK);
            if (LAModConstants.silverOre && !JsonParserModdedOres.loadNetherSilverOre().get("disableOre").getAsBoolean())

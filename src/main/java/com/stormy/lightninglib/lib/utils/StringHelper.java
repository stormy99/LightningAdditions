...
public final class StringHelper
{
    ...
    public static String localize(String key) { return I18n.translateToLocal(key); }

    public static String localizeFormat(String key, Object... format) { return I18n.translateToLocalFormatted(key, format); }
    ...
    public static String getFluidName(FluidStack stack)
    {
        ...
        { name += YELLOW; }
        else if (fluid.getRarity() == EnumRarity.RARE) { name += BRIGHT_BLUE; }
        else if (fluid.getRarity() == EnumRarity.EPIC) { name += PINK; }
        name += fluid.getLocalizedName(stack) + END;
        return name; }

    public static String getFluidName(FluidStack stack, String defaultName) {
        if (stack == null) { return defaultName; }
    ...
    public static String shiftForDetails() {
        ...
        return localize("info.lightninglib.holdShiftForDetails"); }
